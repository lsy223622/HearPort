...
- Unsigned IPA packaging: complete (commits `23c4e6b`, `6105707`, `75b198d`, `317b6cf`, `ecbfdc2`, `d736c58`, `df0de8e`); macos-14 [run 35597785827](https://github.com/lsy223622/HearPort/actions/runs/35597785827) passed both package-test and archive jobs. XcodeGen generated an Xcode 15-compatible project; Xcode 15.4 archive succeeded with signing disabled; bundle ID and `Payload/HearPort.app/Info.plist` were validated. Artifact `HearPort-unsigned-ipa` (ID `10637134436`, 143912 bytes) is available from the run.
